...
Use this role for a pre-publication quality review.
...
- Word count, title word count, subtitle count, subtitle word count, and body-section count meet the selected profile in `config/post-structure.yaml`.
...
- The audience, promise, tone, and call to action are coherent.
- The draft is readable, inclusive, accessible, and appropriate for its channel.
